...
public class WebRequest<T>{
    ...
    {
        sendRequest(type, requestURL, authorization, null, null);
    }
    public static void sendRequest(String type, String requestURL, RequestBody body , OAuthTokenData authorization)
    {
        sendRequest(type, requestURL, authorization, body, null);
    }
    public static <T> T  sendRequest(String type, String requestURL, OAuthTokenData authorization, Class<T> t)
    {
        return sendRequest(type, requestURL, authorization, null, t);
    }
